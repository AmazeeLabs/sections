 ...
 * )
 */
class SectionsMediaFilter extends FilterBase implements ContainerFactoryPluginInterface {
  ...
  public function tips($long = FALSE) {
    return $this->t('You can render media entities created by sections module.');
  }
